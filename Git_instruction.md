...
## 12.1. Создать аккаунт на GitHub.(https://github.com)
## 12.2. Связать удаленный репохиторий с локальным.
Есть несколько способов что бы ваш удаленный репозиторий был связан с проектом в вашей папке:
1)  1. Создать локальный репозиторий(п.4).
    2. Создать удаленный репозиторий на GitHub.
    3. Связать удаленный репозиторий с локальным.
    Если проект только создается, то можно для связки локального и удаленного можно:
    Для начала основная ветка должна совпадать с удаленной веткой, если это не так то необходимо выполнить команду `git branch -M <имя ветки>`, которая переименовывает ветку.

    Для того что бы связать удаленный репозиторий с локальным, необходимо выполнить команду:
    ...
    git remote -v
    ```
    должны быть ссылки на GitHub.

    ```
    git push -u origin <имя ветки>
    ```

2) Получить удаленный репозиторий клонировав проект в папку
```
git clone <url-адрес репозитория>
```
## 13. Отправка изменений в удаленный репозитарий.
Для того что бы получить изменения с удаленного репозитория, необходимо в терминале выполнить команду
```
git push
```
...
```
## 15. Pull Requests.
Если есть необходимть создать pull request, то необходимо:
1. Зайти в проект на GitHub и нажать кнопку Fork(ветвление).
2. Появится Fork в вашем аккуанте, необходимо скопировать https адрес Fork, нажав на кнопку Code, далее Https.
3. Выполнить git clone <url-адрес репозитория, скопированного ранее>
4. Перейти к рут директории проекта выполнив команду
```
cd <путь до директории>
```
5. Создать новую ветку.
6. Перейти в новую ветку.
7. Внести необходимые изменения.
8. Сохранить изменения(п 5.2).
9. Зафиксировать изменения(п 5.3).
10. Отправить в удаленный репозиторий, выполнив команду
```
...
git push --u origin <имя ветки>
```
11. Перейти на ветку, которую мы хотим отправить.
12. Перейти на вкладку Pull Requests.
13. Нажать на кнопку New Pull Request.
14. Выбираем спава ветку откуда пулреквест, слева куда.
